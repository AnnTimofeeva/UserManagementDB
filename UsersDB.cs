...
namespace UserManagementDB
{
    public class UsersDB
    {
        ...
        public bool Insert(DBConnection db, User user)
        {
            ...
            MessageBox.Show($"{user.Name} user's details  are sussessfully added to database");
            return true;
        }
        ...
        public bool Update(DBConnection db, string email, User user)
        {
            ...
            MessageBox.Show($"{user.Name} user's details  are sussessfully updated in the database");
            return true;
        }
        ...
        public bool Delete(DBConnection db, string email)
        {
            ...
            MessageBox.Show($"User with email {email} entry is sussessfully deleted from database");
            return true;
        }
